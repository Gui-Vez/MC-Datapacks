...
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 4 run function water_boss:scripts/code/data/set_waypoints_a with storage main dist.macro
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 8 run function water_boss:scripts/code/data/set_waypoints_b with storage main dist.macro