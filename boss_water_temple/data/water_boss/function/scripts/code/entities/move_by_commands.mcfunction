...
execute if score $WaypointID VAR matches 4 as @e[type=phantom, limit=1, tag=Water_Boss] at @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss f100"] facing entity @p[gamemode=!spectator] eyes run tp @s ^ ^ ^ ~ ~0
