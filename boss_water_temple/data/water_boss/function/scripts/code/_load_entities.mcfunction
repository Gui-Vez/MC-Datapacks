...
summon armor_stand 25 20 15 {NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:0b,Tags:["Water_Boss"],CustomName:'"Water Boss Row Pivot"'}
...
execute as @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Row Pivot"] at @s rotated as @s run tp @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Depth"] ^ ^-5 ^ ~ ~

## Uncomment those lines or remove them completely once the product is finished
# execute as @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"  ] run tp @s -62 8 -16 0 0
# execute as @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"  ] at @s run tp @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Center"] ^ ^ ^ -90 0
# execute as @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Center"] at @s run tp @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Column"] ^ ^ ^ -180 0
# execute as @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Column"] at @s run tp @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Row"] ^ ^ ^ -90 0
# execute as @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Row"   ] at @s run tp @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Row Pivot"] ^ ^ ^ -180 0
# execute as @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Row Pivot"] at @s rotated as @s run tp @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Depth"] ^ ^ ^ ~ ~