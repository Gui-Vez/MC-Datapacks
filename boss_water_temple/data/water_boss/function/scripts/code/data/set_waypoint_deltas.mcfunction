...
scoreboard players operation f100.X VAR += delta_f100.X VAR
scoreboard players operation f100.Y VAR += delta_f100.Y VAR
scoreboard players operation f100.Z VAR += delta_f100.Z VAR

scoreboard players operation f125.X VAR += delta_f125.X VAR
scoreboard players operation f125.Y VAR += delta_f125.Y VAR
scoreboard players operation f125.Z VAR += delta_f125.Z VAR

scoreboard players operation f150.X VAR += delta_f150.X VAR
scoreboard players operation f150.Y VAR += delta_f150.Y VAR
scoreboard players operation f150.Z VAR += delta_f150.Z VAR

scoreboard players operation f175.X VAR += delta_f175.X VAR
scoreboard players operation f175.Y VAR += delta_f175.Y VAR
scoreboard players operation f175.Z VAR += delta_f175.Z VAR
