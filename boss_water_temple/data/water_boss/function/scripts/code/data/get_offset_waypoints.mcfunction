...
execute store result score delta_f25.Y VAR run data get storage main dist.macro.y 0383
...
execute store result score delta_f50.Y VAR run data get storage main dist.macro.y 0707
...
execute store result score delta_f75.Y VAR run data get storage main dist.macro.y 0924
