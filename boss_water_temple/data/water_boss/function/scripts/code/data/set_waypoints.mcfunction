...
data modify entity @e[type=armor_stand, name="f25", limit=1] Pos[0] set from storage main f25.macro.x
data modify entity @e[type=armor_stand, name="f25", limit=1] Pos[1] set from storage main f25.macro.y
data modify entity @e[type=armor_stand, name="f25", limit=1] Pos[2] set from storage main f25.macro.z

data modify entity @e[type=armor_stand, name="f50", limit=1] Pos[0] set from storage main f50.macro.x
data modify entity @e[type=armor_stand, name="f50", limit=1] Pos[1] set from storage main f50.macro.y
data modify entity @e[type=armor_stand, name="f50", limit=1] Pos[2] set from storage main f50.macro.z

data modify entity @e[type=armor_stand, name="f75", limit=1] Pos[0] set from storage main f75.macro.x
data modify entity @e[type=armor_stand, name="f75", limit=1] Pos[1] set from storage main f75.macro.y
data modify entity @e[type=armor_stand, name="f75", limit=1] Pos[2] set from storage main f75.macro.z