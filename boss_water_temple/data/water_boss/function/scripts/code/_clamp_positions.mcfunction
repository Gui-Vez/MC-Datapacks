...
execute as @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Depth"] run scoreboard players operation @s WaterBossXpos = @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Row Pivot"] WaterBossXpos
