...
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 06 run scoreboard players set $PhaseTimerLimit VAR 0001
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 07 run scoreboard players set $PhaseTimerLimit VAR 0001
