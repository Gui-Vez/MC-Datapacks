...
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 6 run schedule function water_boss:scripts/code/phases/6_hover_airborne 1t
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 run schedule function water_boss:scripts/code/phases/7_attack_player 1t
...
execute unless score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 6 run schedule clear water_boss:scripts/code/phases/6_hover_airborne
execute unless score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 run schedule clear water_boss:scripts/code/phases/7_attack_player
