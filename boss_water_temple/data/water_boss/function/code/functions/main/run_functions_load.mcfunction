...
# Summon the entities
execute unless entity @e[type=marker, limit=1, tag=Water_Boss, name="Water Boss Init"] run function water_boss:code/entities/summon/load_phantom
execute unless entity @e[type=marker, limit=1, tag=Water_Boss, name="Water Boss Init"] run function water_boss:code/entities/summon/load_markers

# Obtain scores and remove all tags
function water_boss:code/scores/main/run_scores
function water_boss:code/entities/tags/remove_tags_all

# Set position and rotation values of markers
function water_boss:code/storage/set/set_pivots_positions
function water_boss:code/storage/set/set_pivots_rotations

# Place armor stands out of bounds
function water_boss:code/entities/teleport/teleport_out_of_bounds
