...
function water_boss:code/data/set/set_pivots_positions
function water_boss:code/data/set/set_pivots_rotations

# Reset timers variables
function water_boss:code/scores/timer/reset_timers
