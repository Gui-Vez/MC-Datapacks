...
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 4 run function water_boss:code/storage/set/set_waypoints_jump with storage main dist.macro
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 8 run function water_boss:code/storage/set/set_waypoints_dive with storage main dist.macro