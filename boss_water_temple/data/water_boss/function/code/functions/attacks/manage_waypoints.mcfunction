...
execute if score $WaterBoss_PhaseID WaterBoss_VAR matches 4 run function water_boss:code/storage/set/set_waypoints_jump with storage main dist.macro
execute if score $WaterBoss_PhaseID WaterBoss_VAR matches 8 run function water_boss:code/storage/set/set_waypoints_dive with storage main dist.macro