...
execute as @e[tag=WA_motion_projectile, tag=!motion_added] at @s rotated as @e[type=phantom, limit=1, tag=Water_Boss] run function water_boss:code/storage/get/get_motion
execute as @e[tag=WA_motion_projectile, tag=!motion_added] at @s rotated as @e[type=phantom, limit=1, tag=Water_Boss] run function water_boss:code/storage/set/set_motion
