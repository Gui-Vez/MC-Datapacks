...
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 if score $AttackID VAR matches 2..7 as @e[type=phantom, limit=1, tag=Water_Boss] at @s facing entity @p[gamemode=!spectator] eyes rotated ~ -30 if entity @p[gamemode=!spectator, distance=2.5..5] run tp @s ^ ^ ^0.050 ~ ~
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 if score $AttackID VAR matches 2..7 as @e[type=phantom, limit=1, tag=Water_Boss] at @s facing entity @p[gamemode=!spectator] eyes rotated ~ -40 if entity @p[gamemode=!spectator, distance=0..2.5] run tp @s ^ ^ ^ ~ ~
