...
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 unless score $AttackID VAR matches 1 as @e[type=phantom, limit=1, tag=Water_Boss] at @s rotated ~ -15 facing entity @e[tag=WB_Targeted, distance=..100, limit=1, sort=nearest] eyes unless entity @a[gamemode=!spectator, distance=0..5] unless entity @e[type=armor_stand, tag=WB_Marked, limit=1, distance=0..6] run tp @s ^ ^ ^0.45 ~ ~
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 unless score $AttackID VAR matches 1 as @e[type=phantom, limit=1, tag=Water_Boss] at @s rotated ~ -15 facing entity @p[gamemode=!spectator, distance=..100, limit=1] eyes if entity @e[tag=WB_Marked, limit=1, distance=0..5] run tp @s ^ ^ ^ ~ ~
# TP phantom to its own position, facing the player
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 if score $AttackID VAR matches 2 as @e[type=phantom, limit=1, tag=Water_Boss] at @s facing entity @p[gamemode=!spectator] eyes rotated ~ -20 run tp @s ^ ^ ^ ~ ~
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 if score $AttackID VAR matches 3 as @e[type=phantom, limit=1, tag=Water_Boss] at @s facing entity @p[gamemode=!spectator] eyes rotated ~ -20 run tp @s ^ ^ ^ ~ ~
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 if score $AttackID VAR matches 4 as @e[type=phantom, limit=1, tag=Water_Boss] at @s facing entity @p[gamemode=!spectator] eyes rotated ~ -30 run tp @s ^ ^ ^ ~ ~
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 if score $AttackID VAR matches 5 as @e[type=phantom, limit=1, tag=Water_Boss] at @s facing entity @p[gamemode=!spectator] eyes rotated ~ -30 run tp @s ^ ^ ^ ~ ~
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 if score $AttackID VAR matches 6 as @e[type=phantom, limit=1, tag=Water_Boss] at @s facing entity @p[gamemode=!spectator] eyes rotated ~ -40 run tp @s ^ ^ ^ ~ ~
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 if score $AttackID VAR matches 7 as @e[type=phantom, limit=1, tag=Water_Boss] at @s facing entity @p[gamemode=!spectator] eyes rotated ~ -40 run tp @s ^ ^ ^ ~ ~
# Move phantom towards center of arena
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 if score $AttackID VAR matches 8 as @e[type=phantom, limit=1, tag=Water_Boss] at @s facing entity @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss f100"] eyes run tp @s ^ ^ ^0.75 ~ ~
