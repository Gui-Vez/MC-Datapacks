...
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 unless score $AttackID VAR matches 1 as @e[type=phantom, limit=1, tag=Water_Boss] at @s rotated ~ -15 facing entity @e[tag=WaterBoss_Targeted, distance=..100, limit=1, sort=nearest] eyes unless entity @e[tag=WaterBoss_Targeted, distance=0..5] unless entity @e[type=armor_stand, tag=WaterBoss_Marked, limit=1, distance=0..6] run tp @s ^ ^ ^0.55 ~ ~
execute if score @e[type=armor_stand, limit=1, tag=Water_Boss, name="Water Boss Init"] WaterBossPhaseID matches 7 unless score $AttackID VAR matches 1 as @e[type=phantom, limit=1, tag=Water_Boss] at @s rotated ~ -15 facing entity @p[gamemode=!spectator, distance=..100, limit=1] eyes if entity @e[tag=WaterBoss_Marked, limit=1, distance=0..5] run tp @s ^ ^ ^ ~ ~
