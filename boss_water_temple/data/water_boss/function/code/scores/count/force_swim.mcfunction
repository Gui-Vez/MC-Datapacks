...
execute as @e[type=minecraft:marker, limit=1, name="Water Boss Init", tag=Water_Boss] at @s at @s positioned ~-25 ~-20 ~-25 unless entity @a[gamemode=!spectator, dx=50, dy=75, dz=50] run scoreboard players set $PhaseID WA_VAR 3
